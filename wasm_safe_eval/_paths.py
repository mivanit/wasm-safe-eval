...
def get_rustpython_wasm_path() -> Path:
    ...
    if not output.exists():
        raise RustPythonWasmNotFoundError(
            "The rustpython.wasm file could not be found. this is a bug in the wasm-safe-eval package, please report it at https://github.com/mivanit/wasm-safe-eval/issues"
        )
    return output
